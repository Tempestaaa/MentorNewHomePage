  ...
  return (
    <nav className="fixed w-full px-8 top-0 left-0">
      <div className="md:flex items-center justify-between bg-white py-4">
        ...
        <ul
          className={`font-medium md:text-navAndText w-full md:w-auto h-screen md:h-auto bg-navMobile md:bg-inherit absolute md:static top-0 ${
            isShowNav ? "right-[100%]" : "right-0"
          }`}
        >
      ...
      <img
        src={isShowNav ? menuIcon : closeMenuIcon}
        alt="menu"
